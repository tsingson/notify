...
func unix2C(sec, nsec int64) (C.time_t, C.long) {
...
func (c *cfen) portGet(port int, pe *PortEvent) (err error) {
	...
	pe.PortevEvents, pe.PortevSource, pe.PortevPad = int(cpe.portev_events), uint8(cpe.portev_source), uint8(cpe.portev_pad)
